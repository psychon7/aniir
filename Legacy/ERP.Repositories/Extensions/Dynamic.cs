...
namespace System.Linq.Dynamic
{
    public static class DynamicQueryable
    {
        ...
        public static IEnumerable<TResult> Select<TSource, TResult>(this IEnumerable<TSource> source,
            Expression<Func<TSource, TResult>> selector, params object[] values)
        {
        ...
        public static IEnumerable<T> OrderBy<T>(this IEnumerable<T> query, string propertyName, bool ascending)
        {
            ...
            MethodInfo method = typeof(DynamicQueryable).GetMethod("OrderByProperty", BindingFlags.Static | BindingFlags.NonPublic)
