            ...
            if (oneprd != null)
            {
                ...
                switch (techsheetV)
                {
                    ...
                    case "3":
                        ...
                        output = ERP.SharedServices.PDF.PDFGenerator.GPdfTechSheet_V3(_path, oneprd);
                        break;
                    default:
                        output = ERP.SharedServices.PDF.PDFGenerator.GPdfTechSheet_V2(_path, oneprd);
                        break;
                ...
                else
                {
                    ...
                    string elaPath = "D:/SiteFilesFolder/ERPs/ERP_ECOLED/Files/UploadFiles/Product/Photo/895/1.jpg";
