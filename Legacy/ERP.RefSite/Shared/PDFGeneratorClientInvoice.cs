...
namespace ERP.RefSite.Shared
{
    public static partial class PDFGenerator
    {
        ...
        public static MemoryStream NewGeneratePdfForClientInvoice(string path, ClientInvoice clientinvoice, Society society)
        {
            ...
            table.AddCell(cell);
            cell = CreateHeaderCell(clientinvoice.ClientCompanyName.ToUpper(), BaseColor.WHITE, 7, headerTextFont2, false, Alignement.Left, false, true, leading, footerTop: 0);
            table.AddCell(cell);
            cell = CreateHeaderCell(textSpace, BaseColor.WHITE, 1, bodyFont1st, false, Alignement.Left, false, false, leading, -1);
            table.AddCell(cell);
            ...
            cell = CreateHeaderCell(textSpace, BaseColor.WHITE, 1, bodyFont1st, false, Alignement.Left, false, false, leading, -1);
            table.AddCell(cell);
            string cpvilleDlv = string.Format("{0} {2} {1}", clientinvoice.Dlv_CcoPostcode, clientinvoice.Dlv_CcoCity, !string.IsNullOrEmpty(clientinvoice.Dlv_CcoPostcode) && !string.IsNullOrEmpty(clientinvoice.Dlv_CcoCity) ? "/" : "");
            ...
            cell = CreateHeaderCell(textSpace, BaseColor.WHITE, 1, bodyFont1st, false, Alignement.Left, true, false, leading, -1);
            table.AddCell(cell);
            string cpvilleInv = string.Format("{0} {2} {1}", clientinvoice.Inv_CcoPostcode, clientinvoice.Inv_CcoCity, !string.IsNullOrEmpty(clientinvoice.Inv_CcoPostcode) && !string.IsNullOrEmpty(clientinvoice.Inv_CcoCity) ? "/" : "");
            ...
            cell = CreateHeaderCell(textSpace, BaseColor.WHITE, 1, bodyFont1st, false, Alignement.Left, false, false, leading, -1);
            table.AddCell(cell);
            cell = CreateHeaderCell(string.Format("Date de facutre : {0:dd-MMM-yyyy}", clientinvoice.CinDInvoice), BaseColor.WHITE, 9, bodyFont1st, false, Alignement.Left, false, false, leading, -1);
            table.AddCell(cell);
            ...
            for (int index = 0; index < clientInvoiceLineCount; index++)
            {
                ...
                {
                    Description = string.Format("{0}\r\nhttp://t.e-c-o.com?p={1}", Description, cil.CiiPrdName);
                }
