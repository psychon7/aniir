...
namespace ERP.RefSite.Shared
{
    public static partial class PDFGenerator
    {
        ...
        //public static MemoryStream NewGeneratePdfForSupplierInvoice(string path, PurchaseBaseClass supplierInvoice, Society society)
        //{
        //    int avoirCoef = 1;
        ...
        //    string reportTitle = string.Format("{0} N° : {1}", title, supplierInvoice.SinCode);
        ...
        //    cell = CreateHeaderCell(textSpace, BaseColor.WHITE, 1, bodyFont1st, false, Alignement.Left, false, false, leading, -1);
        //    table.AddCell(cell);
        //    cell = CreateHeaderCell(string.Format("COMPANY"), BaseColor.WHITE, 8, headerTextFont2, false, Alignement.Left, true, true, leading, 10);
        //    table.AddCell(cell);
        //    cell = CreateHeaderCell(textSpace, BaseColor.WHITE, 1, bodyFont1st, false, Alignement.Left, false, false, leading, -1);
        //    table.AddCell(cell);
        ...
        //    table.AddCell(cell);
        //    cell = CreateHeaderCell(society.Society_Name.ToUpper(), BaseColor.WHITE, 7, headerTextFont2, false, Alignement.Left, false, true, leading, footerTop: 0);
        //    table.AddCell(cell);
        //    cell = CreateHeaderCell(textSpace, BaseColor.WHITE, 1, bodyFont1st, false, Alignement.Left, false, false, leading, -1);
        //    table.AddCell(cell);
        ...
        //    cell = CreateHeaderCell(textSpace, BaseColor.WHITE, 1, bodyFont1st, false, Alignement.Left, false, false, leading, -1);
        //    table.AddCell(cell);
        //    cell = CreateHeaderCell(supplierInvoice.OneSupplier.CompanyName.ToUpper(), BaseColor.WHITE, 8, headerTextFont, false, Alignement.Left, true, true, leading, 10);
        //    table.AddCell(cell);
        //    cell = CreateHeaderCell(textSpace, BaseColor.WHITE, 1, bodyFont1st, false, Alignement.Left, false, false, leading, -1);
        //    table.AddCell(cell);
        ...
        //    cell = CreateHeaderCell(textSpace, BaseColor.WHITE, 1, bodyFont1st, false, Alignement.Left, true, false, leading, -1);
        //    table.AddCell(cell);
        //    cell = CreateHeaderCell(supplierInvoice.SupplierContact.Civility.Value + " " + supplierInvoice.SupplierContact.ScoFirstname + " " + supplierInvoice.SupplierContact.ScoLastname.ToUpper(), BaseColor.WHITE, 7, headerTextFont, false, Alignement.Left, false, true, leading, spaceLogo, forFooter: true, footerTop: 0);
        //    table.AddCell(cell);
        //    cell = CreateHeaderCell(textSpace, BaseColor.WHITE, 1, bodyFont1st, false, Alignement.Left, false, false, leading, -1);
        //    table.AddCell(cell);
        ...
        //    cell = CreateHeaderCell(textSpace, BaseColor.WHITE, 1, bodyFont1st, false, Alignement.Left, false, false, leading, -1);
        //    table.AddCell(cell);
        //    cell = CreateHeaderCell(society.Address1, BaseColor.WHITE, 8, headerTextFont, false, Alignement.Left, true, true, leading, 10);
        //    table.AddCell(cell);
        //    cell = CreateHeaderCell(textSpace, BaseColor.WHITE, 1, bodyFont1st, false, Alignement.Left, false, false, leading, -1);
        //    table.AddCell(cell);
        ...
        //    cell = CreateHeaderCell(textSpace, BaseColor.WHITE, 1, bodyFont1st, false, Alignement.Left, true, false, leading, -1);
        //    table.AddCell(cell);
        //    cell = CreateHeaderCell(supplierInvoice.OneSupplier.Address1, BaseColor.WHITE, 7, headerTextFont, false, Alignement.Left, false, true, leading, spaceLogo, forFooter: true, footerTop: 0);
        //    table.AddCell(cell);
        //    cell = CreateHeaderCell(textSpace, BaseColor.WHITE, 1, bodyFont1st, false, Alignement.Left, false, false, leading, -1);
        //    table.AddCell(cell);
        ...
        //    if (!string.IsNullOrEmpty(society.Address2))
        //    {
        //        hasAdr2 = true;
        //        if (!string.IsNullOrEmpty(society.Address2))
        //        {
        //            hasAdr2Liv = true;
        //            cell = CreateHeaderCell(textSpace, BaseColor.WHITE, 1, bodyFont1st, false, Alignement.Left, false, false, leading, -1);
        //            table.AddCell(cell); cell = CreateHeaderCell(society.Address2, BaseColor.WHITE, 8, headerTextFont, false, Alignement.Left, true, true, leading, 10);
        //            table.AddCell(cell);
        //            cell = CreateHeaderCell(textSpace, BaseColor.WHITE, 1, bodyFont1st, false, Alignement.Left, false, false, leading, -1);
        //            table.AddCell(cell);
        //        }
        ...
        //        {
        //            hasAdr2Liv = false;
        //            string cpvilleLiv0 = string.Format("{0} {2} {1}", society.PostCode, society.City, !string.IsNullOrEmpty(society.PostCode) && !string.IsNullOrEmpty(society.City) ? "/" : "");
        //            cell = CreateHeaderCell(textSpace, BaseColor.WHITE, 1, bodyFont1st, false, Alignement.Left, false, false, leading, -1);
        ...
        //        cell = CreateHeaderCell(textSpace, BaseColor.WHITE, 1, bodyFont1st, false, Alignement.Left, true, false, leading, -1);
        //        table.AddCell(cell);
        //        cell = CreateHeaderCell(society.Address2, BaseColor.WHITE, 7, headerTextFont, false, Alignement.Left, false, true, leading, spaceLogo, forFooter: true, footerTop: 0);
        //        table.AddCell(cell);
        //        cell = CreateHeaderCell(textSpace, BaseColor.WHITE, 1, bodyFont1st, false, Alignement.Left, false, false, leading, -1);
        //        table.AddCell(cell);
        //    }
        ...
        //        if (hasAdr2Liv.Value)
        //        {
        //            string cpvilleLiv0 = string.Format("{0} {2} {1}", supplierInvoice.Dlv_CcoPostcode, supplierInvoice.Dlv_CcoCity, !string.IsNullOrEmpty(supplierInvoice.Dlv_CcoPostcode) && !string.IsNullOrEmpty(supplierInvoice.Dlv_CcoCity) ? "/" : "");
        //            cell = CreateHeaderCell(textSpace, BaseColor.WHITE, 1, bodyFont1st, false, Alignement.Left, false, false, leading, -1);
        //            table.AddCell(cell);
        ...
        //    // fac
        //    string cpville = string.Format("{0} {2} {1}", supplierInvoice.Inv_CcoPostcode, supplierInvoice.Inv_CcoCity, !string.IsNullOrEmpty(supplierInvoice.Inv_CcoPostcode) && !string.IsNullOrEmpty(supplierInvoice.Inv_CcoCity) ? "/" : "");
        //    cell = CreateHeaderCell(textSpace, BaseColor.WHITE, 1, bodyFont1st, false, Alignement.Left, true, false, leading, -1);
        //    table.AddCell(cell);
        ...
        //    cell = CreateHeaderCell(textSpace, BaseColor.WHITE, 1, bodyFont1st, false, Alignement.Left, false, false, leading, -1);
        //    table.AddCell(cell);
        //    cell = CreateHeaderCell(string.Format("Date de facutre : {0:dd-MMM-yyyy}", supplierInvoice.CinDInvoice), BaseColor.WHITE, 9, bodyFont1st, false, Alignement.Left, false, false, leading, -1);
        //    table.AddCell(cell);
        //    cell = CreateHeaderCell(string.Format("V/Id CEE : {0}", supplierInvoice.ClientForPdf.VatIntra), BaseColor.WHITE, 9, bodyFont1st, false, Alignement.Left, false, false, leading, -1);
        //    table.AddCell(cell);


        //    cell = CreateHeaderCell(textSpace, BaseColor.WHITE, 1, bodyFont1st, false, Alignement.Left, false, false, leading, -1);
        //    table.AddCell(cell);
        //    cell = CreateHeaderCell(string.Format("Date d'échéance : {0:dd-MMM-yyyy}", supplierInvoice.CinDTerm), BaseColor.WHITE, 9, bodyFont1st, false, Alignement.Left, false, false, leading, -1);
        //    table.AddCell(cell);
        //    cell = CreateHeaderCell(string.Format("Condition de règlement : {0}", supplierInvoice.PaymentCondition), BaseColor.WHITE, 9, bodyFont1st, false, Alignement.Left, false, false, leading, -1);
        //    table.AddCell(cell);


        //    cell = CreateHeaderCell(textSpace, BaseColor.WHITE, 1, bodyFont1st, false, Alignement.Left, false, false, leading, -1);
        //    table.AddCell(cell);
        //    cell = CreateHeaderCell(string.Format("Nom d'Affaire : {0}", supplierInvoice.PrjName), BaseColor.WHITE, 9, bodyFont1st, false, Alignement.Left, false, false, leading, -1);
        //    table.AddCell(cell);
        //    string relatedInvoice = supplierInvoice.CinIsInvoice ? textSpace : string.Format("Facture N° : {0}", supplierInvoice.CinAvCode);

        //    cell = CreateHeaderCell(relatedInvoice, BaseColor.WHITE, 9, headerTextFont2, false, Alignement.Left, false, false, leading, -1);
        //    table.AddCell(cell);
        ...
        //    int clientInvoiceLineCount = supplierInvoice.ClientInvoiceLines.Count;

        //    for (int index = 0; index < clientInvoiceLineCount; index++)
        //    {
        //        var cil = supplierInvoice.ClientInvoiceLines.ElementAt(index);
        ...
        //        string Quantity = (cil.LtpId == 2 || cil.LtpId == 4) ? string.Format("{0:n0}", cil.CiiQuantity) : string.Empty;
        //        string ClnUnitPrice = (cil.LtpId == 2 || cil.LtpId == 4) ? string.Format("{0:n2}", cil.CiiUnitPrice * avoirCoef) : string.Empty;
        ...
        //    var comment = supplierInvoice.CinClientComment;
        ...
        //    // total line title
        //    var allLines = supplierInvoice.ClientInvoiceLines;
        //    var tvaUsed = allLines.Select(m => m.VatId).Distinct().ToList();
        //    int tvaCount = tvaUsed.Count;

        //    bool withDiscount = (supplierInvoice.CinDiscountAmount ?? 0) != 0;
        //    int totalFieldLineCount = withDiscount ? 5 : 4;
        //    var totalHT = allLines.Where(m => m.LtpId == 4 || m.LtpId == 2).Sum(m => (m.CiiPriceWithDiscountHt ?? m.CiiUnitPrice) * m.CiiQuantity) * avoirCoef;
        //    var totalTtc = allLines.Where(m => m.LtpId == 4 || m.LtpId == 2).Sum(m => ((m.CiiPriceWithDiscountHt ?? m.CiiUnitPrice) * m.CiiQuantity) * (1 + m.VatRate / 100)) * avoirCoef;
        //    var discount = supplierInvoice.CinDiscountAmount ?? 0;
        //    var netHt = (totalHT - discount);
        //    var totalTva = allLines.Where(m => m.LtpId == 4 || m.LtpId == 2).Sum(m => ((m.CiiPriceWithDiscountHt ?? m.CiiUnitPrice) * m.CiiQuantity) * (m.VatRate / 100)) * avoirCoef;
        ...
        //            var baseHt = allLines.Where(m => m.VatId == oneTva && (m.LtpId == 4 || m.LtpId == 2)).Distinct().Sum(m => (m.CiiPriceWithDiscountHt ?? m.CiiUnitPrice) * m.CiiQuantity) * avoirCoef;
        //            var tvarate = allLines.FirstOrDefault(m => m.VatId == oneTva).VatRate * avoirCoef;
        //            var tvaamount = allLines.Where(m => m.VatId == oneTva && (m.LtpId == 4 || m.LtpId == 2)).Sum(m => ((m.CiiPriceWithDiscountHt ?? m.CiiUnitPrice) * m.CiiQuantity) * (m.VatRate / 100)) * avoirCoef;
