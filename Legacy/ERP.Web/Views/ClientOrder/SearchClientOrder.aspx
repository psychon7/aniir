<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="SearchClientOrder.aspx.cs" Inherits="ERP.Web.Views.ClientOrder.SearchClientOrder" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script src="../../js/ERP/CommonJS.js?V=<%= WebConfigurationManager.AppSettings["jsVersion"] %>"
        type="text/javascript"></script>
    <script src="../../js/ERP/ClientOrder/ClientOrderSearch.js?V=<%= WebConfigurationManager.AppSettings["jsVersion"] %>"
        type="text/javascript"></script>
    <div class="container">
        <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="page-header">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li><a href="#" class="language_txt">Rechercher une Commande</a> </li>
                            </ul>
                            <!-- /BREADCRUMBS -->
                            <div class="clearfix">
                                <h3 class="content-title pull-left language_txt">Bon de Commande</h3>
                            </div>
                                    ...
                                    <div class="box-body" id="divSearchCondition">
                                        <div class="form-horizontal">
                                            <div class="form-group">
                                                <label class="col-sm-1 control-label language_txt">Code de BC</label>
                                                <div class="col-sm-2">
                                                    <input class="form-control" id="CodCode" name="CodCode" type="text" placeholder="Code de la commande"
                                                        maxlength="200">
                                                </div>
                                                <label class="col-sm-1 control-label language_txt">Nom de BC</label>
                                                <div class="col-sm-2">
                                                    <input class="form-control" id="CodName" name="CodName" type="text" placeholder="Nom de la commande"
                                                        maxlength="200">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-2">
                                                    <input type="text" class="form-control datepicker" id="CodDateCreationFrom" name="CodDateCreationFrom" placeholder="Date de création du" />
                                                </div>
                                                <label class="col-sm-1 control-label language_txt">Date de création au</label>
                                                <div class="col-sm-2">
                                                    <input type="text" class="form-control datepicker" id="CodDateCreationTo" name="CodDateCreationTo" placeholder="Date de création au" />
                                                </div>
                                            ...
                                            <div class="modal-footer center">
                                                <button type="submit" class="btn btn-inverse start rt_read  language_txt" onclick="return jsSearchCpl()">Rechercher</button>
                                                <button type="button" class="btn btn-inverse success rt_create  language_txt" onclick="return createClientOrder()">Créer une Commande</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
