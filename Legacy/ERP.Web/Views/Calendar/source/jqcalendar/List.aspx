<%@ Page Title="jqcalendar" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="ERP.Web.Views.Calendar.source.jqcalendar.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="IsAllDayEvent" HeaderText="IsAllDayEvent" SortExpression="IsAllDayEvent" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="Color" HeaderText="Color" SortExpression="Color" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="RecurringRule" HeaderText="RecurringRule" SortExpression="RecurringRule" ItemStyle-HorizontalAlign="Center"  /> 
