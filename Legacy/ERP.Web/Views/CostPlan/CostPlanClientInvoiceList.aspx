<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="CostPlanClientInvoiceList.aspx.cs" Inherits="ERP.Web.Views.CostPlan.CostPlanClientInvoiceList" %>
                    ...
                    <div class="col-sm-12">
                        <div class="page-header">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="prjMenu">&nbsp;Liste de Facture</li>
                            </ul>
                            <!-- /BREADCRUMBS -->
                            <div class="clearfix">
                                <h3 class="content-title pull-left">
                                    &nbsp;Les Factures du Devis</h3>
                            </div>
                            <div class="description">
                                Tous les Factures Client</div>
                        </div>
                    </div>
                </div>
                <div class="row">
