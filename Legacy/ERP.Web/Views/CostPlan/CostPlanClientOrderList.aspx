<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="CostPlanClientOrderList.aspx.cs" Inherits="ERP.Web.Views.CostPlan.CostPlanClientOrderList" %>
                    ...
                    <div class="col-sm-12">
                        <div class="page-header">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li><a href="SearchCostPlan.aspx">&nbsp;Rechercher un Devis</a> </li>
                                <li class="prjMenu a_pointer"><a onclick="goCostPlanList()" class="a_pointer">&nbsp;Devis</a></li>
                                <li class="prjMenu">&nbsp;Liste de Commande</li>
                                <li class="prjMenu a_pointer"><a onclick="goClientInvoiceList()">&nbsp;Liste de Facture</a></li>
                            </ul>
                            <!-- /BREADCRUMBS -->
                            <div class="clearfix">
                                <h3 class="content-title pull-left">
                                    &nbsp;Les Commandes du Devis</h3>
                            </div>
