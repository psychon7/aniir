<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Message.aspx.cs" Inherits="ERP.Web.Views.Message.Message" %>
<%@ Import Namespace="System.Web.Configuration" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <title>ERP - Centre de messages</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script src="../../js/ERP/CommonJS.js?V=<%= WebConfigurationManager.AppSettings["jsVersion"] %>"
        type="text/javascript"></script>
    <script src="../../js/ERP/Message/MessageJS.js?V=<%= WebConfigurationManager.AppSettings["jsVersion"] %>"
        type="text/javascript"></script>
    <div class="container">
        <div class="row">
            <div id="content" class="col-lg-12">
                    ...
                    <div class="col-sm-12">
                        <div class="page-header">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li>&nbsp;Centre de messages</li>
                            </ul>
                            <!-- /BREADCRUMBS -->
                            <div class="clearfix">
                                <h3 class="content-title pull-left" id="h3_title">
                                    &nbsp;</h3>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                        ...
                        <div class="row" id="div_todo">
                            <div class="col-md-12">
                                <div class="box border inverse">
                                    <div class="box-title">
                                        <h4>
                                            <i class="fa fa-bars"></i>TO DO LIST</h4>
                                    </div>
                                    <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-5">
                                                    <div class="box border inverse" style="max-height: 800px; overflow-y: auto;">
                                                        <div class="box-title">
                                                            <h4>
                                                                <i class="fa fa-bars"></i>DÉJÀ FAITS</h4>
                                                        </div>
                                                        <div class="box-body">
                                                            <div class="form-horizontal" id="div_done_list">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-7">
                                                    <div class="box border inverse" style="max-height: 800px; overflow-y: auto;">
                                                        <div class="box-title">
                                                            <h4>
                                                                <i class="fa fa-fire"></i>À FAIRE</h4>
                                                        </div>
                                                        <div class="modal-body center">
                                                            <button type="button" class="btn btn-inverse" onclick="return addOneTodo(0)">
                                                                Ajouter un ToDo</button>
                                                        </div>
                                                        <div class="box-body">
                                                            <div class="form-horizontal" id="div_todo_list">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                    ...
                    <div class="col-md-12" style="display: none;">
                        <div class="row" id="div_messagelist" style="width: 100%; overflow-x: auto;">
                            <div class="col-md-12">
                                <div class="box border inverse">
                                    <div class="box-title">
                                        <h4>
                                            <i class="fa fa-bars"></i>Messages</h4>
                                    </div>
                                    <div class="box-body">
                                        <div class="form-horizontal">
                                        </div>
