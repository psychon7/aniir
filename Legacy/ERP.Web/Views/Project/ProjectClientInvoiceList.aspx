<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ProjectClientInvoiceList.aspx.cs" Inherits="ERP.Web.Views.Project.ProjectClientInvoiceList" %>
                    ...
                    <div class="col-sm-12">
                        <div class="page-header">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="prjMenu">&nbsp;Liste de Facutre</li>
                            </ul>
                            <!-- /BREADCRUMBS -->
                            <div class="clearfix">
                                <h3 class="content-title pull-left">
                                    &nbsp;Les Factures de cet affaire</h3>
                            </div>
                            <div class="description">
                                Toutes les Factures Client</div>
                        </div>
                    </div>
                </div>
                <div class="row">
