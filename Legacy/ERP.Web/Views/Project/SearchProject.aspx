<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="SearchProject.aspx.cs" Inherits="ERP.Web.Views.Project.SearchProject" %>
...
//            });
    ...
    <script src="../../js/ERP/CommonJS.js?V=<%= WebConfigurationManager.AppSettings["jsVersion"] %>"
        type="text/javascript"></script>
    <script src="../../js/ERP/Project/ProjectSearch.js?V=<%= WebConfigurationManager.AppSettings["jsVersion"] %>"
        type="text/javascript"></script>
    <div class="container">
        <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="page-header">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li><a href="#" class = "language_txt">Rechercher une affaire</a> </li>
                                <li class = "language_txt">Rechercher une projet</li>
                            </ul>
                            <!-- /BREADCRUMBS -->
                            <div class="clearfix">
                                <h3 class="content-title pull-left language_txt">Affaire</h3>
                            </div>
                                    ...
                                    <div class="box-body" id="divSearchCondition">
                                        <div class="form-horizontal">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-2">
                                                    <input class="form-control" id="PrjName" name="PrjName" type="text" 
                                                        maxlength="200">
                                                </div>
                                                <label class="col-sm-2 control-label language_txt">Code de l'affaire</label>
                                                <div class="col-sm-2">
                                                    <input class="form-control" id="PrjCode" name="PrjCode" type="text" 
                                                        maxlength="200">
                                                </div>
                                            ...
                                            <div class="modal-footer center">
                                                <button type="submit" class="btn btn-inverse start language_txt" onclick="return jsSearchPrj()">Rechercher</button>
                                                <button type="button" class="btn btn-inverse success language_txt" onclick="return createProject()">Créer une affaire</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
