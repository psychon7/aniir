<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="SearchClient.aspx.cs" Inherits="ERP.Web.Views.Client.SearchClient" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script src="../../js/ERP/Client/SearchClient.js?V=<%= WebConfigurationManager.AppSettings["jsVersion"] %>" type="text/javascript"></script>
    <div class="container">
        <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="page-header">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li><a href="#" class="language_txt">Rechercher Client</a> </li>
                            </ul>
                            <!-- /BREADCRUMBS -->
                            <div class="clearfix">
                                <h3 class="content-title pull-left language_txt">Client</h3>
                            </div>
                                    ...
                                    <div class="box-body">
                                        <div class="form-horizontal">
                                            <div class="form-group">
                                                ...
                                                <label class="col-sm-1 control-label language_txt">Référence</label>
                                                <div class="col-sm-2">
                                                    <input type="text" class="form-control searchcriteria" id="Reference" name="Reference" placeholder="Référence de client" />
                                                </div>
                                                <label class="col-sm-1 control-label language_txt">Email</label>
                                                <div class="col-sm-2">
                                                ...
                                                <label class="col-sm-1 control-label language_txt">Code postal</label>
                                                <div class="col-sm-2">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-1 control-label language_txt">Ville</label>
                                                <div class="col-sm-2">
                                                    <input type="text" class="form-control searchcriteria" id="City" name="City" placeholder="Ville" />
                                                </div>
                                                <label class="col-sm-1 control-label language_txt">Téléphone</label>
                                                <div class="col-sm-2">
                                                    <div class="input-group">
                                                ...
                                                <label class="col-sm-1 control-label language_txt">Type de client</label>
                                                <div class="col-sm-2">
                                            ...
                                            <div class="modal-footer center">
                                                <button type="button" id="btn_search" class="btn btn-inverse start language_txt" onclick="return js_search_client()">Rechercher</button>
                                                <button type="button" class="btn btn-inverse language_txt" onclick="create_client_click()">Créer un client</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="box border inverse">
                                    ...
                                    <div class="box-body" style="width: 100%; overflow-x: auto;">
                                        <table id="datatable_client_result" cellpadding="0" cellspacing="0" border="0" class="datatable table table-striped table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    <th class="language_txt">Raison sociale</th>
                                                    <th class="language_txt">Référence</th>
                                                    <th class="language_txt">Rôle</th>
