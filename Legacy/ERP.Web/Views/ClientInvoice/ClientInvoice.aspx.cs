...
{
    public partial class ClientInvoice : BasePage.BasePage
    {
        ...
        public static string CreateUpdateClientInvoice(Entities.ClientInvoice oneCin)
        {
            ...
            bool checkOK = ((!oneCin.CinAccount) || (oneCin.CinAccount && oneCin.CinAvId != 0));
            if (checkOK)
            {
                ...
                var values = ClientInvoiceServices.CreateUpdateClientInvoice(oneCin, CurrentUser.LoginMode == 1, CurrentUser.IsAdmin);
