<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ClientInvoiceA.aspx.cs" Inherits="ERP.Web.Views.ClientInvoice.ClientInvoiceA" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script src="../../js/ERP/ClientInvoice/ClientInvoiceA.js?V=<%= WebConfigurationManager.AppSettings["jsVersion"] %>"
        type="text/javascript"></script>
    <%--<script src="../../js/ERP/ClientInvoice/ClientInvoice.js" type="text/javascript"></script>--%>
    <script src="../../js/ERP/ClientInvoice/ClientInvoiceLineA.js?V=<%= WebConfigurationManager.AppSettings["jsVersion"] %>"
        type="text/javascript"></script>
    <!-- hidden fileds -->
                    ...
                    <div class="col-sm-12">
                        <div class="page-header">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li><a href="SearchClientInvoice.aspx">&nbsp;<span class="language_txt">Rechercher une facture/AVOIR</span></a> </li>
                                <li>&nbsp;<span class="language_txt">AVOIR</span></li>
                            </ul>
                            <!-- /BREADCRUMBS -->
                            <div class="clearfix">
                                <h3 class="content-title pull-left">&nbsp;<span class="language_txt">AVOIR</span></h3>
                            </div>
                            <div class="description">
                                <span class="language_txt">Création, modification, consultation un AVOIR</span>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="box border inverse">
                                    ...
                                    <div class="box-body">
                                        <div class="form-horizontal">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label language_txt" style="color: red; display: none;">AVOIR</label>
                                                <div class="col-sm-4" style="display: none;">
                                                    <%--<input class="form-control" type="checkbox" id="CinAccount" name="CinAccount" onclick="VerifyAvoir(this)" />--%>
                                                    <input class="form-control" type="checkbox" id="CinAccount" name="CinAccount" checked="checked"
                                                        disabled="" />
                                                </div>
                                                <label class="col-sm-2 control-label invoicelist fieldRequired language_txt" id="lb_cin_avoir_id"
                                                    ...
                                                    etid="CinAvFId" style="color: red;">
                                                    CODE DE FACTURE POUR AVOIR</label>
                                                <div class="col-sm-4 invoicelist">
                                                    <select class="form-control" id="ClientInvoiceList" name="ClientInvoiceList" style="display: none">
                                                    </select>
                                                    <input class="form-control" id="CinList" name="CinList" onkeyup="CinListKeyUp(this)" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-4">
                                                    ...
                                                    <input class='form-control' id='ClientList' name='ClientList' onkeyup="js_clientChange(this)" />
                                                </div>
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label language_txt">Nom d'AVOIR</label>
                                                <div class="col-sm-4">
                                            ...
                                            <div class="form-group forview fordfo language_txt" style="display: none;">
                                                <label class="col-sm-2 control-label" onclick="return ExternLinkClick(this)" id="lb_dfo"
                                                    flid="DeliveryForm" pgid="DeliveryForm.aspx" prms="dfoId" etid="DfoFId">
                                                    Bon de Livraison</label>
                                                <div class="col-sm-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label class="col-sm-2 control-label">
                                                    <span class="language_txt">Text du pied</span> &#32;</label>
                                                <div class="col-sm-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-4">
                                                    <textarea class="form-control" cols="3" rows="5" id="CinClientComment" name="CinClientComment"></textarea>
                                                </div>
                                                ...
                                                <div class="col-sm-4 forview forcreate">
                                                    <div class="input-group">
                                                        <input class="form-control datepicker " id="_dCreationString" name="_dCreationString"
                                                            required="" disabled /><span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                    </div>
                                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6" id="div_invoicing_address">
                                <div class="box border inverse">
                                    <div class="box-title">
                                        <h4>
                                            <i class="fa fa-globe"></i><span class="language_txt">Adresse de facturation</span></h4>
                                        <div class="tools">
