...
namespace ERP.SharedServices.PDF
{
    public static partial class PDFGenerator
    {
        ...
        public static MemoryStream PdfGCinMa(string path, ClientInvoice clientinvoice, Society society, string DownloadTechSheetUrl, bool withTechSheet = false, int lgsId = 0)
        {
            ...
            if (!string.IsNullOrEmpty(clientinvoice.ClientForPdf.VatIntra))
            {
                cell = CreateHeaderCell(textSpace, BaseColor.WHITE, 10, bodyFont1st, false, Alignement.Left, false, false, leading, -1);
                table.AddCell(cell);
                cell = CreateHeaderCell(textSpace, BaseColor.WHITE, 1, bodyFont1st, false, Alignement.Left, true, false, leading, -1);
                table.AddCell(cell);
                cell = CreateHeaderCell("ICE " + clientinvoice.ClientForPdf.VatIntra,
                    BaseColor.WHITE, 7, headerTextFont, false, Alignement.Left, false, true, leading, spaceLogo, forFooter: true, footerTop: 0);
                table.AddCell(cell);
                cell = CreateHeaderCell(textSpace, BaseColor.WHITE, 1, bodyFont1st, false, Alignement.Left, false, false, leading, -1);
                table.AddCell(cell);
            }
            ...
            table.AddCell(cell);
            cell = CreateHeaderCell(string.Format("Mode de règlement : {0}", clientinvoice.PaymentMode), BaseColor.WHITE, 9, bodyFont1st, false, Alignement.Left, false, false, leading, -1);
            table.AddCell(cell);


            cell = CreateHeaderCell(textSpace, BaseColor.WHITE, 1, bodyFont1st, false, Alignement.Left, false, false, leading, -1);
            table.AddCell(cell);
            cell = CreateHeaderCell(string.Format("Nom d'Affaire : {0}", clientinvoice.PrjName), BaseColor.WHITE, 18, bodyFont1st, false, Alignement.Left, false, false, leading, -1);
            table.AddCell(cell);
            ...
            for (int index = 0; index < clientInvoiceLineCount; index++)
            {
                ...
                {
                    cell = CreateHeaderCell(prdName, BaseColor.WHITE, 3, bodyFont1st, true, Alignement.Left, true, true, leading, 5, forContent: true, withTopBorder: withTopBorder, footerTop: 0, minHeight: minheight);
                    table.AddCell(cell);
                    cell = CreateHeaderCell(allDes, BaseColor.WHITE, 14, bodyFont1st, true, Alignement.Left, true, true, leading, 5, isDescription: true, forContent: true, withTopBorder: withTopBorder, footerTop: 0, minHeight: minheight);
                    table.AddCell(cell);
                    cell = CreateHeaderCell(textSpace, BaseColor.WHITE, 1, bodyFont1st, false, Alignement.Center, false, false, leading, footerTop: 0, minHeight: 5);
                    table.AddCell(cell);
                }
            ...
            cell = CreateHeaderCell(content, BaseColor.WHITE, 6, headerTextFont, false, Alignement.Left, false, false, leading, forContent: false);
            table.AddCell(cell);
            ...
            cell = CreateHeaderCell(ribContent, BaseColor.WHITE, 11, bodyFont, false, Alignement.Center, false, false, leading, withTopBorder: false, forContent: true, isDescription: true, footerTop: 0, minHeight: 10);
            table.AddCell(cell);
            //}
            //else
            //{
            //    cell = CreateHeaderCell(textSpace, BaseColor.WHITE, 11, bodyFont, false, Alignement.Center, false, false, leading, withTopBorder: false, forContent: true, isDescription: true, footerTop: 0, minHeight: 10);
            //    table.AddCell(cell);
            //}
            ...
            if (!string.IsNullOrEmpty(HeaderFooter.ClientInvoicePenality) ||
                !string.IsNullOrEmpty(HeaderFooter.ClientInvoiceDiscountForPrepayment))
            {
                var pageHeight = 790;
                pageHeight = 1200;
                ...
                {
                    table = CreateTable(nbColumns, 0, defineWidths);
                    cell = CreateHeaderCell(textSpace, BaseColor.WHITE, 19, bodyFont1st, false, Alignement.Center, false,
                        false, leading, forContent: true, footerTop: 0, minHeight: 30);
                    table.AddCell(cell);
                    AddTable(middleTable, table);
                ...
                cell = CreateHeaderCell(textSpace, BaseColor.WHITE, 19, bodyFont1st, false, Alignement.Center, false,
                    false, leading, forContent: true, footerTop: 0, minHeight: 5);
                table.AddCell(cell);
                ...
                string penality = string.Format("{0} - {1}", HeaderFooter.ClientInvoicePenality,
                    HeaderFooter.ClientInvoiceDiscountForPrepayment);
                cell = CreateHeaderCell(penality, BaseColor.WHITE, 19, bodyFont, false, Alignement.Left, false, false,
                    leading, forContent: true, footerTop: 0, minHeight: 5);
                table.AddCell(cell);
                string reserveText = HeaderFooter.DeliveryFooterLaw;
                cell = CreateHeaderCell(reserveText, BaseColor.WHITE, 19, bodyFont, false, Alignement.Left, false, false,
                    leading, forContent: true, footerTop: 0, minHeight: 5);
                table.AddCell(cell);
                middleTable.AddCell(table);
            }
        ...
        public static MemoryStream PdfGCinMaWithImg(string path, ClientInvoice clientinvoice, Society society, string DownloadTechSheetUrl, bool withTechSheet = false, int lgsId = 0)
        {
            int avoirCoef = clientinvoice.CinAccount ? -1 : 1;
            CommonServices CommonServices = new CommonServices();
            //CommissionServices CommissionServices = new CommissionServices();
            ...
            cell = CreateHeaderCell("IMAGE", BaseColor.LIGHT_GRAY, 2, bodyFont1st, true, Alignement.Center, true, true, leading, withTopBorder: true, forContent: true, footerTop: 0, minHeight: 15);
            table.AddCell(cell);
            cell = CreateHeaderCell("DÉSIGNATION", BaseColor.LIGHT_GRAY, 4, bodyFont1st, true, Alignement.Center, true, true, leading, withTopBorder: true, forContent: true, footerTop: 0, minHeight: 15);
            table.AddCell(cell);
            cell = CreateHeaderCell("QTÉ", BaseColor.LIGHT_GRAY, 2, bodyFont1st, true, Alignement.Center, true, true, leading, withTopBorder: true, forContent: true, footerTop: 0, minHeight: 15);
            table.AddCell(cell);
            cell = CreateHeaderCell("P. PUB", BaseColor.LIGHT_GRAY, 2, bodyFont1st, true, Alignement.Center, true, true, leading, withTopBorder: true, forContent: true, footerTop: 0, minHeight: 15);
