...
namespace ERP.SharedServices.PDF
{
    public static partial class PDFGenerator
    {
        ...
        public static MemoryStream NewGeneratePdfForDliveryForm(string path, DeliveryForm deliveryform, Society society = null)
        {
            ...
            string contact = string.Format("{0}{1}{2}{3}",
                ...
                //(!string.IsNullOrEmpty(deliveryform.Dlv_CcoFirstname) || !string.IsNullOrEmpty(deliveryform.Dlv_CcoLastname) ? deliveryform.Dlv_Civility : ""),
                "",
            ...
            cell = CreateHeaderCell(textSpace, BaseColor.WHITE, 1, bodyFont1st, false, Alignement.Left, true, false, leading, -1);
            table.AddCell(cell);
            cell = CreateHeaderCell(contact, BaseColor.WHITE, 7, headerTextFont, false, Alignement.Left, false, true, leading, spaceLogo, forFooter: true, footerTop: 0);
            table.AddCell(cell);
            cell = CreateHeaderCell(textSpace, BaseColor.WHITE, 1, bodyFont1st, false, Alignement.Left, false, false, leading, -1);
            table.AddCell(cell);
            ...
            //table.AddCell(cell);
            cell = CreateHeaderCell("RÉFÉRENCE", BaseColor.LIGHT_GRAY, 4, bodyFont1st, true, Alignement.Center, true, true, leading, withTopBorder: true, forContent: true, footerTop: 0, minHeight: 15);
            table.AddCell(cell);
            cell = CreateHeaderCell("IMAGE", BaseColor.LIGHT_GRAY, 3, bodyFont1st, true, Alignement.Center, true, true, leading, withTopBorder: true, forContent: true, footerTop: 0, minHeight: 15);
            table.AddCell(cell);
            cell = CreateHeaderCell("DÉSIGNATION", BaseColor.LIGHT_GRAY, 8, bodyFont1st, true, Alignement.Center, true, true, leading, withTopBorder: true, forContent: true, footerTop: 0, minHeight: 15);
            table.AddCell(cell);
            ...
            for (int index = 0; index < clientInvoiceLineCount; index++)
            {
                ...
                string Quantity = (cil.LtpId == 2 || cil.LtpId == 4 || cil.LtpId == -1) ? string.Format("{0:n2}", cil.DflQuantity) : string.Empty;
                ...
                cil.ColPrdDes = !string.IsNullOrEmpty(cil.ColPrdDes)
                    ? (cil.ColPrdDes.Replace("\r\n", "<br/>").Replace("\n", "<br/>").Replace("\r", "<br/>"))
                    : cil.ColPrdDes;
                cil.ColDescription = !string.IsNullOrEmpty(cil.ColDescription) ? cil.ColDescription : string.Empty;
                cil.ColDescription = !string.IsNullOrEmpty(cil.ColDescription)
                    ? (cil.ColDescription.Replace("\r\n", "<br/>").Replace("\n", "<br/>").Replace("\r", "<br/>"))
                    : cil.ColDescription;
                ...
                {
                    cell = CreateHeaderCell(textSpace, BaseColor.WHITE, 3, bodyFont1st, false, Alignement.Left, false, false, leading, 5, isDescription: true, forContent: true, footerTop: 0, withTopBorder: withTopBorder, minHeight: -1);
                    table.AddCell(cell);
                }
                ...
                table.AddCell(cell);
                cell = CreateHeaderCell(Quantity, BaseColor.WHITE, 2, bodyFont1st, false, Alignement.Right, true, true, leading, forContent: true, footerTop: 0, withTopBorder: withTopBorder, minHeight: 15);
                table.AddCell(cell);
                cell = CreateHeaderCell(textSpace, BaseColor.WHITE, 1, bodyFont1st, false, Alignement.Center, false, false, leading, footerTop: 0, minHeight: 15);
                table.AddCell(cell);
                ...
                else
                {
                    if (index == clientInvoiceLineCount - 1)
                    {
                        ...
                        cell = CreateHeaderCell(textSpace, BaseColor.WHITE, 4, bodyFont1st, true, Alignement.Center, true, true, leading, forContent: true, footerTop: 0, minHeight: 5);
                        table.AddCell(cell);
                        cell = CreateHeaderCell(textSpace, BaseColor.WHITE, 3, bodyFont1st, true, Alignement.Center, false, false, leading, forContent: true, footerTop: 0, minHeight: 5);
                        table.AddCell(cell);
                        cell = CreateHeaderCell(textSpace, BaseColor.WHITE, 8, bodyFont1st, true, Alignement.Left, true, true, leading, 5, forContent: true, footerTop: 0, minHeight: 5);
                        table.AddCell(cell);
                        cell = CreateHeaderCell(textSpace, BaseColor.WHITE, 2, bodyFont1st, true, Alignement.Right, true, true, leading, forContent: true, footerTop: 0, minHeight: 5);
            ...
            table.AddCell(cell);
            cell = CreateHeaderCell(string.Format("{0:n2}", qtytotal), BaseColor.WHITE, 2, bodyFont1st, true, Alignement.Right, true, true, leading, forContent: true, footerTop: 0, minHeight: 5);
            table.AddCell(cell);
            cell = CreateHeaderCell(textSpace, BaseColor.WHITE, 1, bodyFont1st, false, Alignement.Center, false, false, leading, footerTop: 0, minHeight: 15);
            table.AddCell(cell);
            ...
            #region RIB IBAN
            // 2024-11-07 chenglin
            // 2024-11-09 Comment out the code
